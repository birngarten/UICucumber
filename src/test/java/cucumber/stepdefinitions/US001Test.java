...
public class US001Test {
    ...
    public void userEntersValidAd() {
        us001Page.allInputs.get(8).sendKeys(RandomStringUtils.randomAlphabetic(10));
    }
    @And("user enters valid soyad")
    public void userEntersValidSoyad() {
        us001Page.allInputs.get(9).sendKeys(RandomStringUtils.randomAlphabetic(10));
    }
    @And("user enters valid eposta")
    public void userEntersValidEposta() {
        us001Page.allInputs.get(10).sendKeys(RandomStringUtils.randomAlphabetic(10)+"@gmail.com");
    }
}
